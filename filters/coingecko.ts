...
export const coingeckoPriceFilter = async (
    ...
    try {
        ...
        if (data && data[coingeckoid] && data[coingeckoid][currency]) {
            if (
                filter.condition == FilterCondition.GREATER &&
                new Decimal(data[coingeckoid][currency]).greaterThan(
                    new Decimal(price)
                )
            ) {
                return { success: true }
            ...
            if (
                filter.condition == FilterCondition.LESS &&
                new Decimal(data[coingeckoid][currency]).lessThan(
                    new Decimal(price)
                )
            ) {
                return { success: true }
            ...
            if (
                filter.condition == FilterCondition.LESSOREQUAL &&
                new Decimal(data[coingeckoid][currency]).lessThanOrEqualTo(
                    new Decimal(price)
                )
            ) {
                return { success: true }
            ...
            if (
                ...
                new Decimal(data[coingeckoid][currency]).greaterThanOrEqualTo(
                    new Decimal(price)
                )
            ) {
                return { success: true }
            ...
            if (
                ...
                new Decimal(data[coingeckoid][currency]).equals(
                    new Decimal(price)
                )
            ) {
                return { success: true }
